...
export default function MovieCard (props) {
    ...
    <div className="col-6 col-md-4 col-lg-2" key={movie.id}>
        <div className="card mb-2 border-0 vh-50">
            <img  onClick={()=>navigate(`/movie/${movie.id}`)} src={`${process.env.REACT_APP_IMAGE_URL}${movie.poster_path}`} className="card-img-top img-fluid rounded" alt="product thumbnail" />
